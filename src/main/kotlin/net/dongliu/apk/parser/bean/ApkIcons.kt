...
fun ApkIcons.Raster.toImage(): BufferedImage =
 ...
 * The icon interface
 */
sealed interface ApkIcons<T:Any> : Serializable {
    /**
    ...
    data class Empty internal constructor (override val path:String)  : ApkIcons<Unit> {
     ...
     */
    data class Color internal constructor(override val data: String) : ApkIcons<String>, Serializable {
    ...
    data class Adaptive internal constructor(
        override val path:String,
        override val data: Pair<ApkIcons<*>, ApkIcons<*>>
    ) : ApkIcons<Pair<ApkIcons<*>, ApkIcons<*>>>, Serializable {
        /**
         * The foreground icon
         */
        val foreground: ApkIcons<*> get() = data.first
        /**
         * The background icon
         */
        val background: ApkIcons<*> get() = data.second
    ...
    ) : ApkIcons<ByteArray>, Serializable {
